package com.multitv.eventbuilder.ui.conference.conferencechild.adaptor
...
import com.multitv.eventbuilder.model.conference.model.ConferenceSubDataItem

class ConferenceAdaptor(
    private val list: List<ConferenceSubDataItem>,
    private val listener: OnConferenceItemClickListener
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    interface OnConferenceItemClickListener {
        fun onConferenceClick(title: String)
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is LeftViewHolder) {
            ...
            holder.itemView.setOnClickListener { listener.onConferenceClick(item.slug) }
